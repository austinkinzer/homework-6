...
def residual(t, SV, pars, ptr, flags):
    ...
    Q_cond_an = -lambda_an*(SV[ptr.T_elyte] - SV[ptr.T_an])*dyInv_an*pars.A_fac_an
    #Q_cond_an = 0
    ...
    Q_rad = (pars.T_amb**4 - SV[ptr.T_an]**4)*sigma*pars.emmissivity*pars.A_ext
    ...
    Q_cond_ca = -lambda_ca*(SV[ptr.T_ca] - SV[ptr.T_elyte])*dyInv_ca*pars.A_ext
    ...
    Q_rad = (pars.T_amb**4 - SV[ptr.T_ca]**4)*sigma*pars.emmissivity*pars.A_ext
